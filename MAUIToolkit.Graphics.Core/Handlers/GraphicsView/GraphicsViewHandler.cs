...
{
    public static IPropertyMapper<IGraphicsView, GraphicsViewHandler> GraphicsViewMapper =
        new PropertyMapper<IGraphicsView, GraphicsViewHandler>(ViewMapper);

    public static CommandMapper<IGraphicsView, GraphicsViewHandler> GraphicsViewCommandMapper =
        new CommandMapper<IGraphicsView, GraphicsViewHandler>(ViewCommandMapper)
    {
        [nameof(IGraphicsView.Invalidate)] = MapInvalidate
    };

    public GraphicsViewHandler()
        : base(GraphicsViewMapper, GraphicsViewCommandMapper)
    {
