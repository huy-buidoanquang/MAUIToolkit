...
//
// Summary:
//     MAUIToolkit.Core.Controls.Popup displays an alert message with customizable buttons
...
public class CPopup : CView, IParentThemeElement, IThemeElement
{
    ...
    //
    // Summary:
    //     Identifies the MAUIToolkit.Core.Controls.Popup.OverlayMode Microsoft.Maui.Controls.BindableProperty.
    ...
    //
    // Summary:
    //     The popup view of the MAUIToolkit.Core.Controls.Popup that will be displayed when
    //     setting the MAUIToolkit.Core.Controls.Popup.IsOpen property as true.
    ...
    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.Popup.AppliedHeaderHeight property.
    private double appliedHeaderHeight;

    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.Popup.AppliedFooterHeight property.
    private double appliedFooterHeight;

    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.Popup.AppliedBodyHeight property.
    ...
    internal UIVisualEffectView? BlurView;

    //
    // Summary:
    //     Gets or sets a value indicating whether the MAUIToolkit.Core.Controls.Popup.PopupView
    //     is open or not.
    //
    // Value:
    //     The value indicating whether the MAUIToolkit.Core.Controls.Popup.PopupView is open
    //     or not.
    //
    // Remarks:
    //     The MAUIToolkit.Core.Controls.Popup.PopupView will be opened and closed based on
    //     this value.
    public bool IsOpen
    {
        get
    ...
    //     to MAUIToolkit.Core.Controls.Popup.RelativeView. The relative position can also
    //     be absolutely adjusted using the MAUIToolkit.Core.Controls.Popup.AbsoluteX and
    //     MAUIToolkit.Core.Controls.Popup.AbsoluteY properties.
    ...
    //     to the specified MAUIToolkit.Core.Controls.Popup.RelativeView based on the MAUIToolkit.Core.Controls.Popup.RelativePosition.
    //     The pop-up will be displayed based on this property value only when relatively
    //     displaying it by using the MAUIToolkit.Core.Controls.Popup.RelativeView property.
    ...
    //     the MAUIToolkit.Core.Controls.Popup.RelativePosition. The relative position can
    //     also be absolutely adjusted using the MAUIToolkit.Core.Controls.Popup.AbsoluteX
    //     and MAUIToolkit.Core.Controls.Popup.AbsoluteY properties.
    ...
    //
    // Summary:
    //     Gets or Sets a value indicating whether an overlay can be shown around the MAUIToolkit.Core.Controls.Popup.PopupView.
    ...
    //
    // Remarks:
    //     MAUIToolkit.Core.Controls.Popup.PopupStyle does not apply to templated elements.
    ...
    // Remarks:
    //     MAUIToolkit.Core.Controls.Popup.PopupStyle does not apply to templated elements.
    //     MAUIToolkit.Core.Controls.Popup.ShowFooter need to be enabled to display footer.
    ...
    //
    // Summary:
    //     Gets or sets the style to be applied to the PopupView in MAUIToolkit.Core.Controls.Popup.
    ...
    //
    // Remarks:
    //     If MAUIToolkit.Core.Controls.Popup.IsFullScreen is set as true, the height request
    ...
    //
    // Remarks:
    //     MAUIToolkit.Core.Controls.Popup.AutoSizeMode will be applied to MAUIToolkit.Core.Controls.Popup
    //     only if MAUIToolkit.Core.Controls.Popup.ContentTemplate is defined.
    ...
    internal Page? ModalPage => (IPlatformApplication.Current?.Application as Application)?.MainPage?.Navigation?.ModalStack.LastOrDefault();

    //
    // Summary:
    //     This event will be fired whenever the MAUIToolkit.Core.Controls.Popup.PopupView
    //     is shown in the view.
    //
    // Remarks:
    //     This event fires whenever the MAUIToolkit.Core.Controls.Popup.IsOpen property is
    //     set as true.
    ...
    //
    // Summary:
    //     Initializes a new instance of the MAUIToolkit.Core.Controls.Popup class.
    public CPopup()
    {
        Initialize();
    ...
    public void Show(bool icullscreen = false)
    {
        if (PopupOverlay != null)
        {
            if (!IsFullScreen)
            {
                CanShowPopupInFullScreen = icullscreen;
            }
            else
            {
    ...
    //
    // Summary:
    //     Dismisses the MAUIToolkit.Core.Controls.Popup.PopupView from the view.
    public void Dismiss()
    {
        if (IsOpen && !StaysOpen)
        {
    ...
    //
    // Summary:
    //     Refreshes the MAUIToolkit.Core.Controls.Popup.PopupView for run-time value changes.
    public void Refresh()
    {
    ...
    //
    // Summary:
    //     Raises the MAUIToolkit.Core.Controls.Popup.Closed event.
    ...
    //
    // Summary:
    //     Raises the MAUIToolkit.Core.Controls.Popup.Opened event.
    ...
    //     must be made for the MAUIToolkit.Core.Controls.Popup.PopupOverlay instead of the
    ...
    //     of MAUIToolkit.Core.Controls.Popup.
    //
    // Parameters:
    //   propertyName:
    ...
    //
    // Summary:
    //     Delegate for MAUIToolkit.Core.Controls.Popup.StaysOpen bindable property changed.
    //
    //
    // Parameters:
    //   bindable:
    ...
    //
    // Summary:
    //     Delegate for MAUIToolkit.Core.Controls.Popup.IsOpen bindable property changed.
    //
    //
    // Parameters:
    //   bindable:
    ...
    //
    // Summary:
    //     Delegate for MAUIToolkit.Core.Controls.Popup.IsFullScreen bindable property changed.
    //
    //
    // Parameters:
    //   bindable:
    //     Instance of the MAUIToolkit.Core.Controls.Popup class.
    //
    //   oldValue:
    //     Old value in the property.
    //
    ...
    //
    // Summary:
    //     Delegate for MAUIToolkit.Core.Controls.Popup.AutoSizeMode bindable property changed.
    //
    //
    // Parameters:
    //   bindable:
    ...
    //
    // Summary:
    //     Initializes the properties for MAUIToolkit.Core.Controls.Popup.
    ...
    //
    // Summary:
    //     Used to set MAUIToolkit.Core.Controls.Popup.IsOpen value.
    //
    // Parameters:
    //   open:
    ...
    //
    // Summary:
    //     Displays the MAUIToolkit.Core.Controls.Popup.PopupView in the view.
    ...
    private void ApplyOverlayBackground()
    {
        ...
        if (ShowOverlayAlways)
        {
            ...
            {
                PopupOverlayContainer.Blur(this, IsOpen);
            }
        }
        else
        {
    ...
    private void LayoutPopup(double x, double y)
    {
        ...
        if (PopupView != null && PopupView.Handler != null && PopupView.Handler.HasContainer)
        {
            UpdateBounds();
        }
    }
    ...
    private Page? GetViewParentPage(View view)
    {
        if (!(view.Parent is View) && view.Parent is Page page && page != PopupExtension.GetMainPage())
        {
    ...
    //
    // Summary:
    //     Applies animation to the MAUIToolkit.Core.Controls.PopupOverlayContainer.
    ...
    internal void WirePlatformSpecificEvents()
    {
        if (IPlatformApplication.Current?.Application is Application application && application.MainPage != null)
        {
            ...
            {
                application.MainPage.SizeChanged += OnMainPageSizeChanged;
            }
        }
    }
    ...
    {
        PopupView popupView = PopupView;
        UIKeyboard.Notifications.ObserveWillShow(delegate (object? sender, UIKeyboardEventArgs args)
        {
            if (popupView != null)
            {
        ...
        UIKeyboard.Notifications.ObserveWillHide(delegate
        {
            if (popupView != null)
            {
    ...
    //
    // Summary:
    //     This method updates the PopupView Bounds.
    internal void UpdateBounds()
    {
        if (PopupView != null && PopupView.Handler != null && PopupView.Handler.PlatformView != null)
        {
            UIView uIView = (UIView)PopupView.Handler.PlatformView;
            uIView.Bounds = new CGRect(0.0, 0.0, PopupViewWidth, PopupViewHeight);
        }
    }

    //
    // Summary:
    //     This method updates the PopupView Background.
    //
    // Parameters:
    //   brush:
    //     The Popup color to be updated.
    internal void UpdateNativePopupViewBackground(Brush brush)
    {
        if (PopupView != null && PopupView.Handler != null && PopupView.Handler.PlatformView != null)
        {
            (PopupView.Handler.PlatformView as UIView).UpdateBackground(brush);
        }
    }
    ...
    {
        if (PopupView.Handler?.PlatformView is UIView uIView && (PopupStyle.CornerRadius.TopRight != 0.0 || PopupStyle.CornerRadius.TopLeft != 0.0 || PopupStyle.CornerRadius.BottomLeft != 0.0 || PopupStyle.CornerRadius.BottomRight != 0.0))
        {
            UIBezierPath uIBezierPath = new UIBezierPath();
            float num = (float)PopupStyle.CornerRadius.TopLeft;
            float num2 = (float)PopupStyle.CornerRadius.TopRight;
            float num3 = (float)PopupStyle.CornerRadius.BottomLeft;
            float num4 = (float)PopupStyle.CornerRadius.BottomRight;
            uIBezierPath.MoveTo(new CGPoint(0f, num));
            uIBezierPath.AddArc(new CGPoint(num, num), num, (NFloat)Math.PI, (NFloat)Math.PI * 1.5f, clockWise: true);
            uIBezierPath.AddLineTo(new CGPoint(uIView.Bounds.Width - num2, 0));
            uIBezierPath.AddArc(new CGPoint(uIView.Bounds.Width - num2, num2), num2, (NFloat)Math.PI * 1.5f, 0, clockWise: true);
            uIBezierPath.AddLineTo(new CGPoint(uIView.Bounds.Width, uIView.Bounds.Height - num4));
            uIBezierPath.AddArc(new CGPoint(uIView.Bounds.Width - num4, uIView.Bounds.Height - num4), num4, 0, (NFloat)(Math.PI / 2.0), clockWise: true);
            uIBezierPath.AddLineTo(new CGPoint(num3, uIView.Bounds.Height));
            uIBezierPath.AddArc(new CGPoint(num3, uIView.Bounds.Height - num3), num3, (NFloat)(Math.PI / 2.0), (NFloat)Math.PI, clockWise: true);
    ...
    // Parameters:
    //   sender:
    //     The main page of the current application.
    //
    //   e:
    //     The event arguments.
    private void OnMainPageSizeChanged(object? sender, EventArgs e)
    {
        if (IsOpen && PopupView != null)
        {
            ...
            if (relativeView != null)
            {
                base.Dispatcher.Dispatch(ResetPopupWidthHeight);
            }
            else
            {
                ResetPopupWidthHeight();
