...
namespace MAUIToolkit.Core.Controls.Popup
{
    //
    // Summary:
    //     The view that is loaded as the footer of the PopupView in MAUIToolkit.Core.Controls.Popup.CPopup.
    internal class PopupFooter : CView
    {
        ...
        {
            if (FooterView is PopupGrid cGrid && base.Children.Count > 0)
            {
        ...
        {
            if (FooterView is PopupGrid cGrid)
            {
                if (PopupView?.Popup.FooterTemplate == null)
                {
                    ...
                    if (popupView != null && popupView.Popup.AppearanceMode == PopupButtonAppearanceMode.OneButton)
                    {
                        ...
                        cGrid.Children.Add(AcceptButton);
                    ...
                    else
                    {
                        ...
                        cGrid.Children.Add(DeclineButton);
                ...
                else
                {
                    ...
                    cGrid.HorizontalOptions = LayoutOptions.Fill;
                    cGrid.Children.Add(view);
                    Grid.SetColumn((BindableObject)view, 0);
                }

                cGrid.Padding = ((PopupView.Popup.FooterTemplate == null) ? new Thickness(footerPadding) : new Thickness(0.0));
            }
        ...
        private void Initialize()
        {
            ...
            AcceptButton.Text = CPopupResources.GetLocalizedString("AcceptButtonText");
            ...
            DeclineButton.Text = CPopupResources.GetLocalizedString("DeclineButtonText");
