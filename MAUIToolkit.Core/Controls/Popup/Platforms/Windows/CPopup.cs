...
//
// Summary:
//     MAUIToolkit.Core.Controls.CPopup displays an alert message with customizable buttons
//     or loads a desired view within a pop-up window.
public class CPopup : CView, IParentThemeElement, IThemeElement
{
    ...
    public static readonly BindableProperty RelativeViewProperty = BindableProperty.Create("RelativeView", typeof(View), typeof(CPopup), null, BindingMode.Default);
    ...
    //
    // Summary:
    //     Identifies the MAUIToolkit.Core.Controls.CPopup.OverlayMode Microsoft.Maui.Controls.BindableProperty.
    ...
    public static readonly BindableProperty HeaderTemplateProperty = BindableProperty.Create("HeaderTemplate", typeof(Microsoft.Maui.Controls.DataTemplate), typeof(CPopup), null, BindingMode.Default, null, OnHeaderTemplatePropertyChanged);

    //
    // Summary:
    //     Identifies the ContentTemplate bindable property.
    public static readonly BindableProperty ContentTemplateProperty = BindableProperty.Create("ContentTemplate", typeof(Microsoft.Maui.Controls.DataTemplate), typeof(CPopup), null, BindingMode.Default, null, OnContentTemplatePropertyChanged);

    //
    // Summary:
    //     Identifies the FooterTemplate bindable property.
    public static readonly BindableProperty FooterTemplateProperty = BindableProperty.Create("FooterTemplate", typeof(Microsoft.Maui.Controls.DataTemplate), typeof(CPopup), null, BindingMode.Default, null, OnFooterTemplatePropertyChanged);
    ...
    //
    // Summary:
    //     The popup view of the MAUIToolkit.Core.Controls.CPopup that will be displayed when
    //     setting the MAUIToolkit.Core.Controls.CPopup.IsOpen property as true.
    ...
    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.CPopup.AppliedHeaderHeight property.
    private double appliedHeaderHeight;

    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.CPopup.AppliedFooterHeight property.
    private double appliedFooterHeight;

    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.CPopup.AppliedBodyHeight property.
    ...
    //
    // Summary:
    //     Gets or sets a value indicating whether the MAUIToolkit.Core.Controls.CPopup.PopupView
    //     is open or not.
    //
    // Value:
    //     The value indicating whether the MAUIToolkit.Core.Controls.CPopup.PopupView is open
    //     or not.
    //
    // Remarks:
    //     The MAUIToolkit.Core.Controls.CPopup.PopupView will be opened and closed based on
    //     this value.
    public bool IsOpen
    {
        get
    ...
    //     to MAUIToolkit.Core.Controls.CPopup.RelativeView. The relative position can also
    //     be absolutely adjusted using the MAUIToolkit.Core.Controls.CPopup.AbsoluteX and
    //     MAUIToolkit.Core.Controls.CPopup.AbsoluteY properties.
    ...
    //     to the specified MAUIToolkit.Core.Controls.CPopup.RelativeView based on the MAUIToolkit.Core.Controls.CPopup.RelativePosition.
    //     The pop-up will be displayed based on this property value only when relatively
    //     displaying it by using the MAUIToolkit.Core.Controls.CPopup.RelativeView property.
    ...
    //     the MAUIToolkit.Core.Controls.CPopup.RelativePosition. The relative position can
    //     also be absolutely adjusted using the MAUIToolkit.Core.Controls.CPopup.AbsoluteX
    //     and MAUIToolkit.Core.Controls.CPopup.AbsoluteY properties.
    public View RelativeView
    {
        get
        {
            return (View)GetValue(RelativeViewProperty);
        }
        set
        {
    ...
    //
    // Summary:
    //     Gets or Sets a value indicating whether an overlay can be shown around the MAUIToolkit.Core.Controls.CPopup.PopupView.
    ...
    //
    // Remarks:
    //     MAUIToolkit.Core.Controls.CPopup.PopupStyle does not apply to templated elements.
    public Microsoft.Maui.Controls.DataTemplate HeaderTemplate
    {
        get
        {
            return (Microsoft.Maui.Controls.DataTemplate)GetValue(HeaderTemplateProperty);
        }
        set
        {
    ...
    // Remarks:
    //     MAUIToolkit.Core.Controls.CPopup.PopupStyle does not apply to templated elements.
    public Microsoft.Maui.Controls.DataTemplate ContentTemplate
    {
        get
        {
            return (Microsoft.Maui.Controls.DataTemplate)GetValue(ContentTemplateProperty);
        }
        set
        {
    ...
    // Remarks:
    //     MAUIToolkit.Core.Controls.CPopup.PopupStyle does not apply to templated elements.
    //     MAUIToolkit.Core.Controls.CPopup.ShowFooter need to be enabled to display footer.
    public Microsoft.Maui.Controls.DataTemplate FooterTemplate
    {
        get
        {
            return (Microsoft.Maui.Controls.DataTemplate)GetValue(FooterTemplateProperty);
        }
        set
        {
    ...
    //
    // Summary:
    //     Gets or sets the style to be applied to the PopupView in MAUIToolkit.Core.Controls.CPopup.
    ...
    //
    // Remarks:
    //     If MAUIToolkit.Core.Controls.CPopup.IsFullScreen is set as true, the height request
    ...
    //
    // Value:
    //     The default value is MAUIToolkit.Core.Controls.PopupAutoSizeMode.None.
    //
    // Remarks:
    //     MAUIToolkit.Core.Controls.CPopup.AutoSizeMode will be applied to MAUIToolkit.Core.Controls.CPopup
    //     only if MAUIToolkit.Core.Controls.CPopup.ContentTemplate is defined.
    ...
    //
    // Summary:
    //     This event will be fired whenever the MAUIToolkit.Core.Controls.CPopup.PopupView
    //     is shown in the view.
    //
    // Remarks:
    //     This event fires whenever the MAUIToolkit.Core.Controls.CPopup.IsOpen property is
    //     set as true.
    ...
    //
    // Summary:
    //     Initializes a new instance of the MAUIToolkit.Core.Controls.CPopup class.
    public CPopup()
    {
        Initialize();
    ...
    //
    // Summary:
    //     Dismisses the MAUIToolkit.Core.Controls.CPopup.PopupView from the view.
    public void Dismiss()
    {
        if (IsOpen && !StaysOpen)
        {
    ...
    //
    // Summary:
    //     Refreshes the MAUIToolkit.Core.Controls.CPopup.PopupView for run-time value changes.
    public void Refresh()
    {
    ...
    Microsoft.Maui.Controls.ResourceDictionary IParentThemeElement.GetThemeDictionary()
    {
        return null;
    }
    ...
    //
    // Summary:
    //     Raises the MAUIToolkit.Core.Controls.CPopup.Closed event.
    ...
    //
    // Summary:
    //     Raises the MAUIToolkit.Core.Controls.CPopup.Opened event.
    ...
    //     must be made for the MAUIToolkit.Core.Controls.CPopup.PopupOverlay instead of the
    ...
    // Returns:
    //     Selected template.
    internal Microsoft.Maui.Controls.DataTemplate GetTemplate(Microsoft.Maui.Controls.DataTemplate template)
    {
        if (template is Microsoft.Maui.Controls.DataTemplateSelector dataTemplateSelector)
        {
    ...
    //     of MAUIToolkit.Core.Controls.CPopup.
    //
    // Parameters:
    //   propertyName:
    ...
    protected override void OnPropertyChanged([CallerMemberName] string propertyName = null)
    {
        switch (propertyName)
        {
            ...
            case "FlowDirection":
                SetRTL();
                PopupView.FlowDirection = (IsRTL ? Microsoft.Maui.FlowDirection.RightToLeft : base.FlowDirection);
                if (IsOpen)
                {
                    ResetPopupWidthHeight();
                }
    ...
    //
    // Summary:
    //     Delegate for MAUIToolkit.Core.Controls.CPopup.StaysOpen bindable property changed.
    //
    //
    // Parameters:
    //   bindable:
    ...
    //
    // Summary:
    //     Delegate for MAUIToolkit.Core.Controls.CPopup.IsOpen bindable property changed.
    //
    //
    // Parameters:
    //   bindable:
    ...
    //
    // Summary:
    //     Delegate for MAUIToolkit.Core.Controls.CPopup.IsFullScreen bindable property changed.
    //
    //
    // Parameters:
    //   bindable:
    //     Instance of the MAUIToolkit.Core.Controls.CPopup class.
    //
    //   oldValue:
    //     Old value in the property.
    //
    ...
    //
    // Summary:
    //     Delegate for MAUIToolkit.Core.Controls.CPopup.AutoSizeMode bindable property changed.
    //
    //
    // Parameters:
    //   bindable:
    ...
    //
    // Summary:
    //     Initializes the properties for MAUIToolkit.Core.Controls.CPopup.
    private void Initialize()
    {
        LocalizationResourceAccessor.InitializeDefaultResource("MAUIToolkit.Core.Controls.Resources.CPopup");
    ...
    //
    // Summary:
    //     Used to set MAUIToolkit.Core.Controls.CPopup.IsOpen value.
    //
    // Parameters:
    //   open:
    ...
    //
    // Summary:
    //     Displays the MAUIToolkit.Core.Controls.CPopup.PopupView in the view.
    ...
    //   absoluteY:
    //     Absolute Y-Point where the popup should be positioned from the relative view.
    private void PositionPopupRelativeToView(View relativeView, PopupRelativePosition position, double absoluteX, double absoluteY)
    {
    ...
    private int GetFinalWidth(View template)
    {
        if (template != null)
        {
    ...
    private double GetFinalHeight(View template)
    {
        if (template != null)
        {
    ...
    private void CalculateAutoWidth()
    {
        if (ContentTemplate != null)
        {
            View content = PopupView.PopupMessageView.Content;
            if (content != null)
            {
    ...
    private void WireEvents()
    {
        ...
        else if (application == null && Microsoft.Maui.Controls.Application.Current != null)
        {
            Microsoft.Maui.Controls.Application.Current.PropertyChanged += OnCurrentPropertyChanged;
        }
    }
    ...
    private void UnWireEvents()
    {
        ...
        {
            Microsoft.Maui.Controls.Application.Current.PropertyChanged -= OnCurrentPropertyChanged;
            Microsoft.Maui.Controls.Application.Current.MainPage.Loaded -= OnMainPageLoaded;
        }
    }
    ...
    private void OnPageLayoutChanged(object? sender, EventArgs e)
    {
        ...
        (sender as Microsoft.Maui.Controls.Page).LayoutChanged -= OnPageLayoutChanged;
    }
    ...
    private void OnCurrentPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        else if (application == null && Microsoft.Maui.Controls.Application.Current != null && Microsoft.Maui.Controls.Application.Current.MainPage != null)
        {
            Microsoft.Maui.Controls.Page mainPage = Microsoft.Maui.Controls.Application.Current.MainPage;
            mainPage.Loaded += OnMainPageLoaded;
        }
    }
    ...
    {
        Microsoft.Maui.Controls.Page page = (sender as Shell)?.CurrentPage;
        if (page != null)
        {
    ...
    private Microsoft.Maui.Controls.Page? GetViewParentPage(View view)
    {
        if (!(view.Parent is View) && view.Parent is Microsoft.Maui.Controls.Page page && page != PopupExtension.GetMainPage())
        {
            view.Parent = PopupExtension.GetMainPage();
        }

        View view2 = view.Parent as View;
        if (view2 == null)
        {
            return view.Parent as Microsoft.Maui.Controls.Page;
        }

        while (view2 != null && view2.Parent != null && !(view2.Parent is Microsoft.Maui.Controls.Page))
        {
            view2 = view2.Parent as View;
        }

        return view2.Parent as Microsoft.Maui.Controls.Page;
    }
    ...
    {
        bool result = false;
        Microsoft.Maui.Controls.Page viewParentPage = GetViewParentPage(this);
    ...
    //
    // Summary:
    //     Applies animation to the MAUIToolkit.Core.Controls.CPopupOverlayContainer.
    ...
    private void ApplyPopupAnimation()
    {
        ...
        {
            PopupView popupView = PopupView;
            ((IView)popupView).Frame = new Rect(popupXPosition, popupYPosition, PopupViewHeight, PopupViewWidth);
        }
    ...
    private void FadeAnimate(View view, double startvalue, double endvalue)
    {
        View view2 = view;
        uint rate = 16u;
        Easing animationEasing = GetAnimationEasing();
    ...
    //   endvalue:
    //     End value of the animator.
    private void ZoomAnimate(View view, float startvalue, float endvalue)
    {
        View view2 = view;
        uint rate = 16u;
        Easing animationEasing = GetAnimationEasing();
    ...
    //   endvalue:
    //     End value of the animator.
    private void SlideAnimate(View view, double startvalue, double endvalue)
    {
        View view2 = view;
        uint rate = 16u;
        Easing animationEasing = GetAnimationEasing();
    ...
    private void ProcessAnimationCompleted(View view)
    {
    ...
    //   animationInProgress:
    //     Animation value.
    private void SetAnimationProgress(View view, bool animationInProgress)
    {
    ...
    internal void WirePlatformSpecificEvents()
    {
        ...
        {
            WindowOverlayHelper.PlatformRootView.SizeChanged += OnPlatformRootViewSizeChanged;
        }

        if (PopupView != null && PopupView.Handler != null && PopupView.Handler.PlatformView != null)
        {
            (PopupView.Handler.PlatformView as LayoutPanelExt).SizeChanged += OnNativePopupViewSizeChanged;
        }
    }
    ...
    internal async void UpdateNativePopupViewShadowMask()
    {
        if (PopupView != null && PopupView.Handler != null && PopupView.Handler.PlatformView != null)
        {
            LayoutPanelExt popupNativeView = (LayoutPanelExt)PopupView.Handler.PlatformView;
            if (this.dropShadow != null)
            {
                DropShadow dropShadow = this.dropShadow;
                //dropShadow.Mask = await popupNativeView.GetAlphaMaskAsync((int)PopupViewWidth, (int)PopupViewHeight);
                dropShadow.Mask = await popupNativeView.GetAlphaMaskAsync();
            }
        }
    }
    ...
    internal async void ApplyNativePopupViewShadow()
    {
        ...
        {
            if (!(shadowCanvas != null) && PopupView != null && PopupView.Handler != null && PopupView.Handler.PlatformView != null)
            {
                if (!PopupView.Handler.HasContainer)
                {
                    PopupView.Handler.HasContainer = true;
                    UpdateRTL();
                }

                LayoutPanelExt popupNativeView = (LayoutPanelExt)PopupView.Handler.PlatformView;
                shadowCanvas = new Canvas();
                (PopupView.Handler.ContainerView as WrapperView).Children.Insert(0, shadowCanvas);
                Compositor compositor = ElementCompositionPreview.GetElementVisual(shadowCanvas).Compositor;
                shadowHost = new Rectangle
                {
                    Fill = new SolidColorBrush(Colors.Transparent).ToBrush(),
                    Width = PopupViewWidth,
                    Height = PopupViewHeight
                };
                Canvas.SetLeft(shadowHost, 0.0);
                Canvas.SetTop(shadowHost, 0.0);
                shadowCanvas.Children.Insert(0, shadowHost);
                this.dropShadow = compositor.CreateDropShadow();
                this.dropShadow.BlurRadius = 20f;
                this.dropShadow.Color = Color.FromRgba(0.0, 0.0, 0.0, 0.3).ToWindowsColor();
                DropShadow dropShadow = this.dropShadow;
                //dropShadow.Mask = await popupNativeView.GetAlphaMaskAsync((int)PopupViewWidth, (int)PopupViewHeight);
                dropShadow.Mask = await popupNativeView.GetAlphaMaskAsync();
                this.dropShadow.Offset = new Vector3(0f, 0f, 0f);
                shadowVisual = compositor.CreateSpriteVisual();
                shadowVisual.Shadow = this.dropShadow;
                shadowVisual.Size = new Vector2((float)PopupViewWidth, (float)PopupViewHeight);
    ...
    {
        if (PopupView?.Handler != null && PopupView.Handler.ContainerView != null && PopupView.Handler.ContainerView is WrapperView)
        {
            ((WrapperView)PopupView.Handler.ContainerView).FlowDirection = (IsRTL ? Microsoft.UI.Xaml.FlowDirection.RightToLeft : Microsoft.UI.Xaml.FlowDirection.LeftToRight);
        }
    }
    ...
    //
    // Summary:
    //     Occurs when popupview size is changes.
    //
    // Parameters:
    //   sender:
    //     The platform root view.
    //
    //   e:
    //     The event arguments.
    private void OnPlatformRootViewSizeChanged(object sender, SizeChangedEventArgs e)
    {
        if (IsOpen && PopupView != null)
        {
            PopupOverlay.UpdateOverlaySize();
            AbortPopupViewAnimation();
            ResetAnimatedProperties();
            ReAssignPopupViewWidthAndHeight();
            ResetPopupWidthHeight();
            if (IsOpen && ShowOverlayAlways && OverlayMode == PopupOverlayMode.Blur)
            {
    ...
    // Parameters:
    //   sender:
    //     The native popupview.
    //
    //   e:
    //     The event arguments.
    private void OnNativePopupViewSizeChanged(object? sender, SizeChangedEventArgs e)
    {
        if (shadowVisual != null && shadowHost != null && shadowVisual.Size != new Vector2((float)PopupViewWidth, (float)PopupViewHeight))
        {
            shadowVisual.Size = new Vector2((float)PopupViewWidth, (float)PopupViewHeight);
            shadowHost.Width = PopupViewWidth;
            shadowHost.Height = PopupViewHeight;
