...
namespace MAUIToolkit.Graphics.Core
{
    public abstract class ViewHandler
	{
		...
		public static readonly PropertyMapper<IView, IElementHandler> Mapper = new PropertyMapper<IView, IElementHandler>(Microsoft.Maui.Handlers.ViewHandler.ViewMapper)
		{
