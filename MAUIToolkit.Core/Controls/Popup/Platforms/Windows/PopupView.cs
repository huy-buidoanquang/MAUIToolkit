...
//
// Summary:
//     Defines the pop-up view of MAUIToolkit.Core.Controls.CPopup.
internal class PopupView : CView
{
    //
    // Summary:
    //     Gets or sets the MAUIToolkit.Core.Controls.CPopup.
    ...
    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.PopupView.AppliedHeaderHeight property.
    private int appliedHeaderHeight;

    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.PopupView.AppliedFooterHeight property.
    private int appliedFooterHeight;

    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.PopupView.AppliedBodyHeight property.
    private int appliedBodyHeight;

    //
    // Summary:
    //     Backing field for the MAUIToolkit.Core.Controls.PopupView.IsViewLoaded property.
    ...
    //
    // Summary:
    //     Initializes a new instance of the MAUIToolkit.Core.Controls.PopupView class.
    //
    // Parameters:
    //   cPopup:
    //     MAUIToolkit.Core.Controls.CPopup instance.
    ...
    //
    // Summary:
    //     Render the border around the MAUIToolkit.Core.Controls.PopupView.
    ...
    protected override void OnHandlerChanged()
    {
        ...
        {
            base.Handler.HasContainer = true;
            Popup.UpdateRTL();
        }
    ...
    //
    // Summary:
    //     Initializes the proprties of the MAUIToolkit.Core.Controls.PopupView class.
