...
public partial class SignaturePadHandler : ViewHandler<ISignaturePad, NativeSignaturePad>, ISignaturePadHandler, IViewHandler, IElementHandler
{
    ...
    public static PropertyMapper<ISignaturePad, SignaturePadHandler> Mapper =
        new PropertyMapper<ISignaturePad, SignaturePadHandler>((PropertyMapper)Microsoft.Maui.Handlers.ViewHandler.ViewMapper)
    {
    ...
    public static CommandMapper<ISignaturePad, ISignaturePadHandler> CommandMapper =
        new CommandMapper<ISignaturePad, ISignaturePadHandler>(Microsoft.Maui.Handlers.ViewHandler.ViewCommandMapper) { ["Clear"] = MapClear };
