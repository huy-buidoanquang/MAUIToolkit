...
public partial class CSignaturePadHandler : ViewHandler<ICSignaturePad, NativePlatformSignaturePad>, ICSignaturePadHandler, IViewHandler, IElementHandler
{
    ...
    public static PropertyMapper<ICSignaturePad, CSignaturePadHandler> Mapper =
        new PropertyMapper<ICSignaturePad, CSignaturePadHandler>((PropertyMapper)Microsoft.Maui.Handlers.ViewHandler.ViewMapper)
    {
    ...
    public static CommandMapper<ICSignaturePad, ICSignaturePadHandler> CommandMapper =
        new CommandMapper<ICSignaturePad, ICSignaturePadHandler>(Microsoft.Maui.Handlers.ViewHandler.ViewCommandMapper) { ["Clear"] = MapClear };
    ...
    {
        return new NativePlatformSignaturePad();
    }
